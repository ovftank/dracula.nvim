...
---@variable.member default boolean Don't override existing definition |:hi-default|
...
local function setup(configs)
   ...
   return {
      ...
      Structure = { fg = colors.cyan, italic = true, },
      TypeDef = { fg = colors.cyan, italic = true, },
      Special = { fg = colors.green, italic = true },
      SpecialComment = { fg = colors.comment, italic = true, },
      Error = { fg = colors.red, underline = true, italic = true, },
      ...
      StatusLineTerm = { fg = colors.fg, bg = colors.bg_darker, },
      ...
      ['@annotation'] = { fg = colors.green, italic = true, },
      ...
      ['@variable.parameter.reference'] = { fg = colors.orange, italic = true, },
      ...
      ['@markup.link.url'] = { fg = colors.cyan, },      -- urls
      ...
      ['@decorator'] = { fg = colors.green, italic = true },

      -- LSP Semantic (0.9+)
      ['@lsp.type.class'] = { fg = colors.cyan },
      ['@lsp.type.enum'] = { fg = colors.cyan },
      ['@lsp.type.decorator'] = { fg = colors.green, italic = true },
      ...
      markdownHeadingDelimiter = { fg = colors.purple, },
      ...
      DiagnosticWarn = { fg = colors.cyan, },
      DiagnosticInfo = { fg = colors.cyan, },
      DiagnosticHint = { fg = colors.cyan, },
      DiagnosticUnderlineError = { undercurl = true, sp = colors.red, },
      DiagnosticUnderlineWarn = { undercurl = true, sp = colors.cyan, },
      ...
      DiagnosticFloatingWarn = { fg = colors.cyan, },
      DiagnosticFloatingInfo = { fg = colors.cyan, },
      DiagnosticFloatingHint = { fg = colors.cyan, },
      DiagnosticVirtualTextError = { fg = colors.red, },
      DiagnosticVirtualTextWarn = { fg = colors.cyan, },
      DiagnosticVirtualTextInfo = { fg = colors.cyan, },
      DiagnosticVirtualTextHint = { fg = colors.cyan, },

      LspDiagnosticsDefaultError = { fg = colors.red, },
      LspDiagnosticsDefaultWarning = { fg = colors.cyan, },
      ...
      LspDiagnosticsUnderlineWarning = { fg = colors.cyan, undercurl = true, },
